...
export default function HomePage() {
  ...
  // Settings gear shows an attention dot when sync needs a look.
  const syncNeedsAttention = !!(
    syncInfo && syncInfo.sync_folder &&
    (syncInfo.folder_problem || (syncInfo.peers || []).some(p => p.clock_skew_minutes))
  );
    ...
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            href="/settings"
            title={syncNeedsAttention ? 'Settings — sync needs attention' : 'Settings'}
            className="relative p-2 text-gray-500 hover:text-gray-800 rounded-lg hover:bg-gray-50"
          >
